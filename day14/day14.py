...
def solve(template, n_steps, rules, pairs):
...
def solve_part_1(template, rules, pairs):
    return solve(template, 10, rules, pairs)


def solve_part_2(template, rules, pairs):
    return solve(template, 40, rules, pairs)
...
def main():
    ...
    sol1 = solve_part_1(template, rules, pairs)
    print(f'Part 1: {sol1}')
    sol2 = solve_part_2(template, rules, pairs)
    print(f'Part 2: {sol2}')
